...
fn fread_chunk(file_in: &str) -> (Vec<Vec<Vec<u8>>>, usize, usize, usize) {
...
fn read_basic_params(file_params: &str) -> (usize, usize, usize, u8) {
...
fn cmp_files(file1: &str, file2: &str) -> bool {
